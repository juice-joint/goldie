import { useCurrentSong, useQueueChanges } from "../../api/sse/hooks";
      ...
      <div>
        {nextSongs.length > 0 ? (
          nextSongs.map((song, i) => (
            ...
            >
              <div className="flex items-center gap-3">
                <div className="w-5 h-5 flex items-center justify-center rounded-full bg-purple-100 text-purple-900 text-xs font-medium">
                  {i + 1}
                </div>
